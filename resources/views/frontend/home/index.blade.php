...
<head>
    ...
    <link href="{{ asset('themes/cargo/css/bootstrap.min.css') }}" rel="stylesheet" type="text/css">
    <link href="{{ asset('themes/cargo/css/jquery.fancybox.min.css') }}" rel="stylesheet" type="text/css">
    <link href="{{ asset('themes/cargo/css/owl.carousel.min.css') }}" rel="stylesheet" type="text/css">
    <link href="{{ asset('themes/cargo/css/owl.theme.default.min.css') }}" rel="stylesheet" type="text/css">
...
<script src="{{asset('themes/cargo/js/jquery-3.3.1.min.js')}}"></script>
<script src="{{asset('themes/cargo/js/popper.min.js')}}"></script>
<script src="{{asset('themes/cargo/js/bootstrap.min.js')}}"></script>
<script src="{{asset('themes/cargo/js/owl.carousel.min.js')}}"></script>
<script src="{{asset('themes/cargo/js/jquery.sticky.js')}}"></script>
<script src="{{asset('themes/cargo/js/jquery.waypoints.min.js')}}"></script>
<script src="{{asset('themes/cargo/js/jquery.animateNumber.min.js')}}"></script>
