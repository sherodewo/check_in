...
@section('content')
    ...
    <form action="{{ route('facility.update', $data) }}" method="POST">
        @csrf
        @method('PUT')
        ...
        <div class="row ml-2 mr-2 mt-2 mb-3">
            ...
            <div class="col-6">
                <div class="form-group">
                    ...
                    <input type="description" name="description" value="{{ old('description')!==null ? old('description') : $data->description }}" class="form-control" placeholder="description">
                </div>
            </div>
